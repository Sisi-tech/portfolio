...
const Contact = () => {
  ...
  return (
    <div name='contact' className='w-full md:h-screen sm:h-auto bg-[#e5ddf4] flex flex-col justify-center items-center p-4 gap-4'>
      <form onSubmit={handleSubmit} className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-5 pt-20'>
          <p className='text-3xl sm:text-4xl border-b-4 border-purple-800 inline mt-0'>Contact</p>
      ...
      <div className={!mobile ? 'sm:hidden' : 'flex'}>
            <ul className='flex flex-row justify-left gap-6 pt-4 py-4'>
              ...
              <li className='w-[50px] h-[50px] rounded-lg flex justify-center items-center bg-[#888888]
                text-white text-4xl shadow-md shadow-gray-400 hover:scale-110'>
                <a href='https://raw.githubusercontent.com/Sisi-tech/portfolio/main/src/assets/SisiResume.pdf' download="Resume.pdf">
