  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-8 bg-[#cbb9f7] text-black'>
        ...
        <div className='hidden md:flex'>
            <ul className='hidden md:flex md:text-2xl text-xl gap-5 mr-14'>
                <li>
        ...
        <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
            <ul>
                ...
                <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300'
                    ...
                    <a className='flex justify-between items-center w-full text-gray-100' 
                        href="mailto:sisiwang242@gmail.com">
                ...
                <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300'
                    ...
                    <a className='flex justify-between items-center w-full text-gray-100' 
                        href="https://raw.githubusercontent.com/Sisi-tech/portfolio/main/src/assets/Sisi_Resume.pdf" download="Resume.pdf">
