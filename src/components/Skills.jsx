...
const Skills = () => {
  return (
    <div name='skills' className='w-full sm:h-auto md:h-screen  bg-[#e5ddf4]'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-start'>
            <div className='pt-20'>
                <p className='text-3xl sm:text-4xl font-bold inline border-b-4 border-purple-800'>Skills</p>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8'>
                <div className='shadow-md shadow-[#cbb9f7] hover:scale-110 hover:shadow-[#c1aef3] duration-500 pt-2 pb-2'>
